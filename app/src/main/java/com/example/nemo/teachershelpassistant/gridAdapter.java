...
public class gridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        }else if(names.get(position).toString().equals("STUDENTPROFILE"))
        {
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        Uri ring = Uri.parse(sharedPrefs.getString("Notification_Sound", Settings.System.NOTIFICATION_SOUND.toString()));

        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                .setTicker("IMPORTANT!!!").setContentTitle("Notes Are Available For this subject")
